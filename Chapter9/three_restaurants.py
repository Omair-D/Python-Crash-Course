...
# Make two more instances and and call describe_restaurant() for all of them
restaurant2 = Restaurant('Chipotle', 'Mexican food')
restaurant3 = Restaurant('A1 Japan', 'Japanese food')
